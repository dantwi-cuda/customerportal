...
import type { Shop, ShopKpi } from '@/@types/shop'
...
const ShopViewPage = () => {
    ...
    const [kpis, setKpis] = useState<ShopKpi[]>([])
    ...
    const fetchShopKpis = async (shopId: number) => {
        setKpisLoading(true)
        try {
            const data = await ShopService.getShopKpis(shopId)
            setKpis(data)
        } catch (error) {
                        ...
                        <div className="p-6">
                            ...
                            shop.programNames.length > 0 ? (
                                <div className="space-y-2">
                                    {shop.programNames.map((program, index) => (
                                        <div
                                            key={index}
